        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.05] text-gray-950">
              BlankSlate <br />
              <span className="text-[#1D4ED8]">Insights & Papers</span>
            </h1>
                    ...
                    <div className="space-y-4">
                      <div className="rounded-2xl overflow-hidden aspect-[16/10] relative bg-gray-100">
                        ...
                        <div className="absolute top-3 left-3">
                          <span className="px-2.5 py-1 bg-white/95 backdrop-blur-md border border-gray-200 text-[#1D4ED8] text-[9px] font-mono font-bold uppercase rounded shadow-sm">
                            {art.category}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <h2 className="text-xl font-bold text-gray-950 group-hover:text-[#1D4ED8] transition-colors leading-snug">
                          {art.title}
                        </h2>
