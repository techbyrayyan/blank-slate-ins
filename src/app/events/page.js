        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.05] text-gray-950">
              ...
              <span className="text-[#E50914]">& Masterclasses</span>
            </h1>
            ...
            {upcomingEvents.map((evt, idx) => (
              ...
              >
                ...
                <div className="lg:col-span-2 flex items-baseline gap-2 lg:flex-col lg:items-start">
                  <span className="text-5xl sm:text-6xl font-mono font-black text-[#E50914] leading-none">
                    {evt.day}
                  </span>
                ...
                <div className="lg:col-span-7 space-y-3">
                  <span className="px-2.5 py-0.5 rounded bg-gray-100 border border-gray-200 text-[#E50914] text-[10px] font-mono font-bold uppercase">
                    {evt.category}
                  </span>
                  <h2 className="text-2xl sm:text-3xl font-black text-gray-950 leading-tight group-hover:text-[#E50914] transition-colors">
                    {evt.title}
                  </h2>
                  ...
                  <div className="flex flex-wrap items-center gap-6 pt-2 text-xs font-mono text-gray-500">
                    <span className="flex items-center gap-1.5">
                      <Clock className="w-3.5 h-3.5 text-[#E50914]" /> {evt.time}
                    </span>
                    <span className="flex items-center gap-1.5">
                      <MapPin className="w-3.5 h-3.5 text-[#E50914]" /> {evt.location}
                    </span>
                  </div>
                </div>
                ...
                <div className="lg:col-span-3 flex justify-start lg:justify-end">
                  <motion.button
                    ...
                    className="w-full sm:w-auto px-6 py-3.5 bg-[#E50914] hover:bg-[#B91C1C] text-white text-xs font-black uppercase tracking-wider rounded-xl transition-all shadow-md flex items-center justify-center gap-2"
                  >
