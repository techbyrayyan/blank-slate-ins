    ...
    <section className="py-8 sm:py-10 bg-white relative overflow-hidden" id="admissions-banner">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden border border-[#1D4ED8]/20 shadow-[0_0_50px_rgba(229,9,20,0.2)] bg-gradient-to-r from-[#0f172a] via-[#1e3a8a] to-[#0f172a]"
        >
          {/* Ambient Red Glows */}
          <div className="absolute top-0 right-1/4 w-[450px] h-[300px] bg-[#1D4ED8]/20 rounded-full blur-[100px] pointer-events-none"></div>
          <div className="absolute bottom-0 left-10 w-[350px] h-[200px] bg-[#1D4ED8]/15 rounded-full blur-[90px] pointer-events-none"></div>
          ...
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#0f172a]/90 via-[#1e3a8a]/80 to-[#0f172a]/90"></div>
          </div>
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4 text-xs font-mono text-gray-300">
                {[
                  ...
                  <div key={item.step} className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#1D4ED8] text-white flex items-center justify-center text-[10px] font-bold">
                        {item.step}
                      </span>
            ...
            <div className="lg:col-span-5 space-y-6 lg:text-right">
              ...
              <div className="flex flex-wrap items-center lg:justify-end gap-3.5 pt-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => onOpenApply()}
                  className="px-7 py-3.5 bg-[#1D4ED8] hover:bg-[#B91C1C] text-white text-xs font-black uppercase tracking-wider rounded-full shadow-[0_4px_20px_rgba(229,9,20,0.5)] transition-all flex items-center gap-2"
                >
                  <span>Apply Now</span>
