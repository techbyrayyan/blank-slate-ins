        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {whyChooseItems.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-white group-hover:bg-[#E50914] text-[#E50914] group-hover:text-white shadow-md flex items-center justify-center mb-6 transition-colors duration-300">
